...
const EditArticlePage = () => {
    ...
    const handleSaveDraft = async () => {
        if (!title || !subTitle || !articleContent || !thumbnail || !categoryId || tags.length === 0) {
        ...
        let parsedContent;
        try {
            // If articleContent is empty (not updated), use post.content
            const contentToParse = articleContent || post?.content || '';
                        ...
                        <div className="p-6 border-b border-gray-200">
                            ...
                            <div className="mt-6">
                                ...
                                <div className="border rounded-lg overflow-hidden">
                                    <TiptapEditor content={post?.content || ''} onChange={setArticleContent} />
                                </div>
                            </div>
                        </div>
                    </div>
