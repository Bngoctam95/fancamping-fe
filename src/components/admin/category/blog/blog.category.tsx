import { deletePostCategoryAPI, getPostCategoriesAPI } from 'services/api';
import { DeleteTwoTone, EditTwoTone } from '@ant-design/icons';
import { App, Button, Popconfirm, Table } from 'antd';
import type { TableProps } from 'antd';
import { useEffect, useState } from 'react';
import CreateCategory from 'components/admin/category/blog/create.category';
import { formatDate } from 'services/helper';
import UpdateCategory from 'components/admin/category/blog/update.category';
...
const BlogCategory = () => {
    ...
    const handleDeleteCategory = async (id: string) => {
        ...
        const res = await deletePostCategoryAPI(id);
        if (res?.data) {
    ...
    const refreshData = async () => {
        try {
            setLoading(true);
            const response = await getPostCategoriesAPI();
