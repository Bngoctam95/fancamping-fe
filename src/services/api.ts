...
export const updateUserAPI = (_id: string, name: string, phone: string) => {
    const urlBackend = `users/${_id}`;
    return (
        axios.put<IBackendRes<IRegister>>(urlBackend, { name, phone })
    )
}
...
export const createUserAPI = (name: string, email: string, password: string, phone: string) => {
    ...
    return (
        axios.post<IBackendRes<IUserTable>>(urlBackend, { name, email, password, phone })
    )
}
...
export const getEquipmentCategoriesAPI = () => {
    ...
    return (
        axios.get<IBackendRes<IEquipmentCategory>>(urlBackend)
    )
}
...
export const createEquipmentCategoryAPI = (name: string, slug: string, description: string) => {
    const urlBackend = "products/categories";
    return (
        axios.post<IBackendRes<IEquipmentCategory>>(urlBackend, { name, slug, description })
    )
}
...
export const deleteEquipmentCategoryAPI = (_id: string) => {
    ...
    return (
        axios.delete<IBackendRes<IDeleteEquipmentCategory>>(urlBackend)
    )
}
...
export const updateEquipmentCategoryAPI = (_id: string, name: string, slug: string, description: string) => {
    const urlBackend = `products/categories/${_id}`;
    return (
        axios.put<IBackendRes<IEquipmentCategory>>(urlBackend, { name, slug, description })
    )
}
...
export const getProductsAPI = (query: string) => {
    ...
    return (
        axios.get<IBackendRes<IModelPaginate<IProductTable>>>(urlBackend)
    )
}
...
export const createProductAPI = (
    ...
    return (
        axios.post<IBackendRes<IProductTable>>(urlBackend, {
            name,
            slug,
            shortDescription,
            description,
